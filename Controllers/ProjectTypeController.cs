    ...
    public class ProjectTypeController : ControllerBase
    {
        ...
        */
        ...
        public ActionResult<ProjectTypeReadDto> CreateProjectType(ProjectTypeCreateDto createProjectTypeDto)
        {
            ...
            return CreatedAtRoute(nameof(GetProjectTypeById), new { Id = readProjectTypeDto.id_project_type }, readProjectTypeDto);
        }
        ...
        public ActionResult<ProjectTypeReadDto> UpdateProjectType(int id, ProjectTypeUpdateDto updateProjectTypeDto)
        {
            ...
            return CreatedAtRoute(nameof(GetProjectTypeById), new { Id = updateProjectTypeDto.id_project_type }, updateProjectTypeDto);
        }
        ...
        public ActionResult DeleteProjectTypeById(int id)
        {
            ...
            if (projectId != null)
            {
                _repository.DeleteProjectTypeById(projectId.id_project_type);
                _repository.SaveChanges();
                return Ok();
            }else{
                return NotFound();
